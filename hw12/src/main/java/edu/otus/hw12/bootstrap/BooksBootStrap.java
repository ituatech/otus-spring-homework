package edu.otus.hw12.bootstrap;

import edu.otus.hw12.entities.Author;
import edu.otus.hw12.entities.Book;
import edu.otus.hw12.entities.Comment;
import edu.otus.hw12.entities.Genre;
import edu.otus.hw12.entities.User;
import edu.otus.hw12.repository.BookRepository;
...
public class BooksBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<User> initUsers() {
        ...
        users.add(User.builder().login("admin").password(DigestUtils.md5Hex("admin")).build());
