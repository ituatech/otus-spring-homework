...
public class CommentServiceTest {
    ...
    public void insertTest() {
        when(commentRepository.findByBookTitle(newComment.getBook().getTitle())).thenReturn(Collections.singletonList(newComment));
    ...
    public void removeTest() {
        when(commentRepository.findByBookTitle(newComment.getBook().getTitle())).thenReturn(Collections.EMPTY_LIST);
        commentService.add(newComment);
