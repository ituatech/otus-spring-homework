...
public class BookRepositoryTest {
    ...
    public void setUp() {
        newBook = Book.builder()
                ...
                .authors(Collections.singletonList(Author.builder().id("au").authorName("masha").build()))
                .genres(Collections.singletonList(Genre.builder().id("ge").genreName("fiction").build()))
                .build();
    }
